...
a result; see the correction banner at the top of `roadmap.md` and the
chat log around 2026-08-21 for the specifics.
...
- Calibration was hard-won: grade-level was too easy, high-school prep was
...
- He completed 6/6 in three earlier lanes (Physical Science, Logic, Earth &
  Space) before they were swapped out. He EARNED those.
- Progress is keyed `subjectId:dayId`. Never renumber or reuse a day id —
  that silently erases his history. This is the single most damaging
  mistake possible here.
- The Explore app has an import panel specifically so he gets his finished
  lanes credited back instead of staring at zeros. Losing badges demoralizes
  a timid kid far more than it would a confident one.

THE PARENT (who you're actually talking to)
- Deeply invested, highly engaged, wants to be challenged like "a parent
  with an advanced degree." Says "don't hold back."
- Wants honest tradeoffs stated up front — especially anything that risks
  the child's progress, and file-size/scope limits. Don't over-promise or
  quietly cut scope.
- Wants concise wrap-ups, and test-driven iteration: the child runs a
  lesson, parent reports back "too easy / too hard / just right," then tune.
  Calibration comes from the kid, not from assumptions.

GOAL: summer-long, expandable coursework that keeps pace with him — and
mostly, that keeps convincing him he's capable.
