    ...
    days: [
      /* ---- ch1 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'You see bubbles rising in a pan. This tells you:', choices: ['a chemical change is definitely happening', 'a gas is being released — which could be either kind of change', 'nothing is happening', 'a physical change is definitely happening'], answer: 1, hint: 'Think about a pot of water on the stove.', explain: 'Boiling water bubbles and stays water. Bubbles are evidence a gas appeared, not proof of which kind of change made it.' },
      ...
      /* ---- ch2 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Mendeleev left gaps in his periodic table because:', choices: ['he ran out of space', 'the pattern predicted elements nobody had discovered yet', 'he could not decide where to put them', 'those elements were too dangerous to include'], answer: 1, hint: 'What happened in the decades afterwards?', explain: 'He trusted the pattern over the known facts and predicted properties for elements yet to be found. They turned up, close to his predictions.' },
      ...
      /* ---- ch3 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Neon barely reacts with anything because:', choices: ['its outer electron shell is already full', 'it is too light', 'it has no electrons', 'its nucleus is unstable'], answer: 0, hint: 'What would neon have to gain from bonding?', explain: 'Bonding is about getting a full outer shell. Neon already has one, so it has nothing to gain and nothing to trade.' },
      ...
      /* ---- ch4 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Diamond and graphite differ because:', choices: ['they are made of different elements', 'the same carbon atoms are arranged differently', 'graphite contains an impurity', 'diamond is compressed graphite dust'], answer: 1, hint: 'Check what each is actually made of.', explain: 'Both are pure carbon. The arrangement is the whole difference — which is a striking demonstration that structure matters as much as ingredients.' },
      ...
      /* ---- ch6 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'To balance a chemical equation you may change:', choices: ['the subscripts', 'the coefficients in front of each formula', 'either one', 'neither — you rewrite the products'], answer: 1, hint: 'What does a subscript actually describe?', explain: 'A subscript defines the substance itself — change it and H₂O becomes H₂O₂, a different chemical. Coefficients just count how many molecules.' },
      ...
      /* ---- ch8 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'How much more acidic is pH 4 than pH 6?', choices: ['slightly — two small steps', '2 times', '20 times', '100 times'], answer: 3, hint: 'Count the steps, then remember what each step means.', explain: 'Each step is ten times. Two steps is ten times ten — a hundredfold difference, not a small one.' },
      ...
      /* ---- ch9 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Salt dissolving in water is:', choices: ['a chemical change — a new substance forms', 'a physical change — the salt can be recovered unchanged', 'neither', 'a chemical change because it disappears'], answer: 1, hint: 'Can you get the salt back?', explain: 'Boil the water off and the salt is still there, unchanged. Nothing new was made, so it is physical.' },
      ...
      /* ---- ch10 --------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'After the reaction it speeds up has finished, a catalyst is:', choices: ['used up', 'still there, ready to do it again', 'converted into a product', 'destroyed by the heat'], answer: 1, hint: 'Could it work on a second batch?', explain: 'It lowers the energy needed but is not consumed. That is exactly why a small amount can process an enormous quantity.' },
