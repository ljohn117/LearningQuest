  ...
  chem: {
    ...
    days: [
      /* ---- ch1 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'What makes a change chemical rather than physical?', choices: ['the substance changes colour or state', 'atoms rearrange into different substances', 'energy is given off as heat or light', 'the change cannot easily be reversed'], answer: 1, hint: 'Ask what you have at the end — the same stuff, or new stuff?', explain: 'A chemical change produces substances that were not there before. Speed and heat are side effects, not the definition.' },
          { type: 'mc', prompt: 'You see bubbles rising in a pan. This tells you:', choices: ['a chemical change is definitely happening', 'a physical change is definitely happening', 'a gas is appearing, by either kind of change', 'the liquid has been contaminated'], answer: 2, hint: 'Think about a pot of water on the stove.', explain: 'Boiling water bubbles and stays water. Bubbles are evidence a gas appeared, not proof of which kind of change made it.' },
          ...
          { type: 'mc', prompt: 'You cannot get burnt paper back because:', choices: ['the atoms were rebuilt into new substances', 'the atoms in the paper were destroyed', 'the ash is too light to gather up', 'the reaction happened far too quickly'], answer: 0, hint: 'Nothing was destroyed — but was anything left the same?', explain: 'The atoms all still exist, rearranged into ash, smoke and gas. Undoing that needs another reaction, not just cooling it down.' },
        ],
      },
      ...
      /* ---- ch2 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The periodic table is ordered by:', choices: ['date of discovery', 'proton count', 'alphabetical name', 'how common the element is'], answer: 1, hint: 'Which number is an element’s identity?', explain: 'Atomic number — the proton count — sets the order, exactly as Physical Science defined it.' },
          { type: 'mc', prompt: 'Two elements in the same column probably:', choices: ['are both metals', 'weigh the same', 'react in similar ways', 'were discovered together'], answer: 2, hint: 'Why bother stacking them?', explain: 'Shared behaviour is why they are stacked. That is what the columns are for.' },
          { type: 'mc', prompt: 'Mendeleev left gaps in his periodic table because:', choices: ['he had run out of room on the page', 'those elements were too dangerous to list', 'he could not decide where to put them', 'the pattern predicted undiscovered elements'], answer: 3, hint: 'What happened in the decades afterwards?', explain: 'He trusted the pattern over the known facts and predicted properties for elements yet to be found. They turned up, close to his predictions.' },
          { type: 'mc', prompt: 'Helium is used in balloons instead of hydrogen because helium:', choices: ['barely reacts with anything, so cannot burn', 'is far more common in the atmosphere', 'is noticeably lighter than hydrogen is', 'is considerably cheaper to produce'], answer: 0, hint: 'Which column is helium in?', explain: 'Hydrogen burns. Helium sits in the unreactive column and will not catch fire.' },
        ],
      },
      ...
      /* ---- ch3 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which electrons take part in bonding?', choices: ['the innermost ones', 'the outermost ones', 'all of them equally', 'the ones in the nucleus'], answer: 1, hint: 'Which ones actually meet the other atom?', explain: 'The valence electrons — the outer layer. The inner ones never get close enough to matter.' },
          { type: 'mc', prompt: 'Neon barely reacts with anything because:', choices: ['it is too light to hold a bond', 'its nucleus is unusually stable', 'its outer electron shell is already full', 'it has fewer electrons than protons'], answer: 2, hint: 'What would neon have to gain from bonding?', explain: 'Bonding is about getting a full outer shell. Neon already has one, so it has nothing to gain and nothing to trade.' },
          { type: 'mc', prompt: 'An atom with one electron more than a full layer will most likely:', choices: ['take another one', 'split in half', 'share it', 'give it away'], answer: 3, hint: 'Which is less work — losing one, or collecting seven?', explain: 'Dropping one spare electron leaves a full layer underneath. Collecting seven more would be absurd by comparison.' },
      ...
      /* ---- ch4 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'In an ionic bond, electrons are:', choices: ['transferred from one atom to the other', 'shared equally between both atoms', 'split evenly and then destroyed', 'pulled into the nucleus of one atom'], answer: 0, hint: 'One atom ends up positive, the other negative. How?', explain: 'One atom hands an electron over, creating the opposite charges that then attract.' },
          { type: 'mc', prompt: 'Two non-metals that both need electrons will most likely:', choices: ['both give electrons away', 'share a pair', 'refuse to bond', 'form an ionic bond'], answer: 1, hint: 'Neither one can take if neither one will give.', explain: 'Sharing lets both count the same pair toward a full outer layer.' },
          { type: 'mc', prompt: 'Diamond and graphite differ because:', choices: ['they are made of different elements', 'graphite contains a trapped impurity', 'the same carbon atoms are arranged differently', 'diamond is graphite under great pressure'], answer: 2, hint: 'Check what each is actually made of.', explain: 'Both are pure carbon. The arrangement is the whole difference — which is a striking demonstration that structure matters as much as ingredients.' },
          { type: 'mc', prompt: 'Salt melts at 801°C and water at 0°C mainly because:', choices: ['salt crystals are much larger than water', 'salt is considerably heavier than water', 'water is already a liquid to begin with', 'ionic bonds in a grid take more energy'], answer: 3, hint: 'What is holding each one together?', explain: 'Every ion in the salt grid is pulled on by its neighbours. Water molecules only cling loosely to each other.' },
        ],
      },
      ...
      /* ---- ch5 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'H2O2 is not water because:', choices: ['the ratio of the atoms is different', 'it is a gas rather than a liquid', 'its atoms are heavier than water', 'it contains a different element'], answer: 0, hint: 'Count the atoms of each element in both.', explain: 'Water is 2:1 hydrogen to oxygen. H2O2 is 2:2 — one extra oxygen per molecule, and a completely different substance.' },
      ...
      /* ---- ch6 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A burning log seems to lose mass because:', choices: ['heat has negative mass', 'gases escape into the air', 'mass turns into light', 'atoms are destroyed by fire'], answer: 1, hint: 'What would happen if you did it in a sealed jar?', explain: 'Weigh the jar and nothing changes. The mass left as carbon dioxide and water vapour.' },
          { type: 'mc', prompt: 'To balance a chemical equation you may change:', choices: ['the subscripts', 'either one', 'the coefficients in front of each formula', 'neither — you rewrite the products'], answer: 2, hint: 'What does a subscript actually describe?', explain: 'A subscript defines the substance itself — change it and H₂O becomes H₂O₂, a different chemical. Coefficients just count how many molecules.' },
          ...
          { type: 'mc', prompt: 'Conservation of mass says that in a reaction:', choices: ['the substances themselves stay the same', 'some mass is converted into energy', 'mass increases as new bonds are formed', 'the total number of atoms stays the same'], answer: 3, hint: 'What is being conserved — the substances, or the atoms?', explain: 'The substances change completely. The atoms are all still there, rearranged.' },
        ],
      },
      ...
      /* ---- ch7 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'An exothermic reaction:', choices: ['releases energy and warms its surroundings', 'absorbs energy and cools its surroundings', 'neither absorbs nor releases energy', 'destroys energy'], answer: 0, hint: '"Exo" means out.', explain: 'The new bonds release more than the old ones cost, and the leftover leaves as heat.' },
          { type: 'mc', prompt: 'Breaking a chemical bond:', choices: ['releases energy', 'requires energy to be put in', 'has no energy cost', 'always produces heat'], answer: 1, hint: 'Which direction takes effort — pulling apart or snapping together?', explain: 'Breaking costs energy; forming releases it. Whether a reaction heats or cools depends on which of the two wins overall.' },
          { type: 'mc', prompt: 'An instant cold pack gets cold because what happens inside it:', choices: ['it releases its heat into the ground', 'it contains ice sealed inside a pouch', 'it absorbs more energy than it releases', 'it has no chemical energy left in it'], answer: 2, hint: 'Where is the cold coming from?', explain: 'It is endothermic. The energy it needs is pulled in from its surroundings, including your hand.' },
          { type: 'mc', prompt: 'Photosynthesis is endothermic, which means it:', choices: ['releases energy stored in the soil', 'gives off heat as the sugar forms', 'destroys the sunlight that reaches it', 'stores the absorbed energy in sugar'], answer: 3, hint: 'What does the plant end up with that it did not have before?', explain: 'Light energy goes in and is stored in the bonds of a sugar molecule. Nothing is created — it is converted, exactly as Physical Science promised.' },
        ],
      },
      ...
      /* ---- ch8 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'A solution with pH 9 is:', choices: ['basic', 'neutral', 'acidic', 'not measurable'], answer: 0, hint: 'Which side of 7 is it on?', explain: 'Above 7 is basic. Baking soda solution sits around there.' },
          { type: 'mc', prompt: 'How much more acidic is pH 4 than pH 6?', choices: ['slightly — two small steps', '100 times', '20 times', '2 times'], answer: 1, hint: 'Count the steps, then remember what each step means.', explain: 'Each step is ten times. Two steps is ten times ten — a hundredfold difference, not a small one.' },
      ...
      /* ---- ch9 ---------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The main difference between a mixture and a compound is that in a compound the substances are:', choices: ['spread out completely evenly', 'heavier than they were before', 'always in the solid state', 'chemically bonded in a fixed ratio'], answer: 3, hint: 'Can you pick the parts back out?', explain: 'Bonding and a fixed ratio. That is also why a compound has new properties instead of shared ones.' },
          ...
          { type: 'mc', prompt: 'Salt dissolving in water is:', choices: ['a physical change — the salt comes back', 'a chemical change — a new substance forms', 'a chemical change, since it disappears', 'neither physical nor chemical change'], answer: 0, hint: 'Can you get the salt back?', explain: 'Boil the water off and the salt is still there, unchanged. Nothing new was made, so it is physical.' },
          { type: 'mc', prompt: 'Table salt is safe to eat even though sodium is violently reactive and chlorine is poisonous, because:', choices: ['the two dangers cancel each other out', 'a compound has entirely new properties', 'cooking removes the danger from both', 'the quantities involved are very small'], answer: 1, hint: 'What does bonding actually do to the ingredients?', explain: 'A compound does not average its ingredients — it replaces them with something new.' },
        ],
      },
      ...
      /* ---- ch10 --------------------------------------------------------- */
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Heating a reaction speeds it up because the particles:', choices: ['become more reactive elements', 'weigh less', 'move faster and collide more often', 'get bigger'], answer: 2, hint: 'What does temperature actually measure?', explain: 'Temperature is particle motion. Faster particles collide more often and hit harder.' },
          { type: 'mc', prompt: 'After the reaction it speeds up has finished, a catalyst is:', choices: ['used up', 'destroyed by the heat', 'converted into a product', 'still there, ready to do it again'], answer: 3, hint: 'Could it work on a second batch?', explain: 'It lowers the energy needed but is not consumed. That is exactly why a small amount can process an enormous quantity.' },
          { type: 'mc', prompt: 'Sawdust burns far faster than a solid log because:', choices: ['far more of it is exposed surface', 'it is a different substance', 'it weighs less', 'it is drier'], answer: 0, hint: 'Where can collisions actually happen?', explain: 'Almost every particle is on a surface, so almost all of it can react at once.' },
          { type: 'mc', prompt: 'Enzymes are important in living things because they:', choices: ['store energy for the cell to use later', 'make reactions fast enough at body heat', 'raise the temperature of the whole body', 'break down waste products in the blood'], answer: 1, hint: 'You cannot cook yourself to speed up digestion.', explain: 'They lower the activation energy, which is the only lever available when you cannot raise the heat.' },
        ],
      },
    ],
  },
