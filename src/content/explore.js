    ...
    days: [
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Because resources are scarce, every choice you make:', choices: ['costs you the next best thing you gave up', 'can be avoided by saving more money', 'makes the resource less scarce for others', 'only matters for expensive purchases'], answer: 0, hint: 'If you spend the money here, what did you not spend it on?', explain: 'Every choice has an opportunity cost — the best thing you did not pick. That is what makes scarcity bite even when you can afford something.' },
        ],
      },
      {
