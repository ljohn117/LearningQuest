    ...
    days: [
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'All living things are made of:', choices: ['sand', 'cells', 'metal', 'plastic'], answer: 1, hint: 'The basic unit of life.', explain: 'Cells are the building block of life.' },
          ...
          { type: 'mc', prompt: 'Which is NOT on the list of traits of living things?', choices: ['reproducing', 'responding to surroundings', 'being made of metal', 'using energy'], answer: 2, hint: 'Three of these are real traits.', explain: 'Being metal is not a trait of life.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which part is the cell’s control center?', choices: ['membrane', 'mitochondria', 'cell wall', 'nucleus'], answer: 3, hint: 'It holds the DNA.', explain: 'The nucleus controls the cell.' },
          ...
          { type: 'mc', prompt: 'Which is found in plant cells but NOT animal cells?', choices: ['mitochondria', 'cell wall', 'nucleus', 'membrane'], answer: 1, hint: 'It gives plants stiffness.', explain: 'Only plant cells have a cell wall.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Photosynthesis releases:', choices: ['carbon dioxide', 'nitrogen', 'helium', 'oxygen'], answer: 3, hint: 'The gas you breathe in.', explain: 'It releases oxygen.' },
          ...
          { type: 'mc', prompt: 'The original source of nearly all energy for life is:', choices: ['wind', 'the Sun', 'the Moon', 'soil'], answer: 1, hint: 'Photosynthesis starts with it.', explain: 'Energy traces back to the Sun.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'A recessive trait appears only when:', choices: ['one copy is recessive', 'it is dominant', 'there is no DNA', 'both copies are recessive'], answer: 3, hint: 'Dominant wins whenever present.', explain: 'Both copies must be recessive.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Which is the MOST specific level?', choices: ['class', 'species', 'kingdom', 'phylum'], answer: 1, hint: 'Run down the taxonomy order — kingdom, phylum, class, order, family, genus, species. The narrowest is at the end.', explain: 'Species is the most specific level.' },
          { type: 'mc', prompt: 'Which is the BROADEST level listed?', choices: ['genus', 'family', 'kingdom', 'species'], answer: 2, hint: 'Run down the taxonomy order — kingdom, phylum, class, order, family, genus, species. The widest is at the start.', explain: 'Kingdom is the broadest level.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Plants that make their own food are called:', choices: ['consumers', 'decomposers', 'predators', 'producers'], answer: 3, hint: 'They produce food from sunlight.', explain: 'Plants are producers.' },
          ...
          { type: 'mc', prompt: 'Food chains are usually short because:', choices: ['water is heavy', 'energy runs out at each level', 'animals get bored', 'plants are rare'], answer: 1, hint: 'Only 10% passes up.', explain: 'Energy loss limits chain length.' },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The part of a sentence telling what the subject does is the:', choices: ['adjective', 'title', 'predicate', 'subject'], answer: 2, hint: 'It carries the action.', explain: 'That is the predicate.' },
          { type: 'mc', prompt: 'Which can stand alone as a sentence?', choices: ['a dependent clause', 'a fragment', 'a phrase', 'an independent clause'], answer: 3, hint: 'The name is a hint.', explain: 'Independent clauses stand alone.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Facts and examples that back up the main idea are:', choices: ['a fragment', 'a predicate', 'supporting evidence', 'the topic'], answer: 2, hint: 'They make it believable.', explain: 'That is supporting evidence.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: '"Her voice was gravel" is a:', choices: ['clause', 'metaphor', 'simile', 'summary'], answer: 1, hint: 'It says one thing IS another.', explain: 'That is a metaphor.' },
          { type: 'mc', prompt: '"The wind argued with the door" is:', choices: ['imagery only', 'a fragment', 'personification', 'a simile'], answer: 2, hint: 'Wind cannot argue.', explain: 'Human traits given to wind — personification.' },
          { type: 'mc', prompt: 'Language that appeals to the senses is:', choices: ['a predicate', 'a thesis', 'taxonomy', 'imagery'], answer: 3, hint: 'It creates pictures and sounds.', explain: 'That is imagery.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'A story using "I" is written in:', choices: ['second person only', 'no point of view', 'first person', 'third person'], answer: 2, hint: 'The narrator is in the story.', explain: 'Using I is first person.' },
          { type: 'mc', prompt: '"The mob swarmed" instead of "the crowd gathered" changes the:', choices: ['page number', 'font', 'length only', 'tone'], answer: 3, hint: 'It changes how you feel.', explain: 'Word choice shifts tone.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Explaining WHY your evidence supports your point is:', choices: ['imagery', 'analysis', 'evidence', 'tone'], answer: 1, hint: 'The step most writers skip.', explain: 'That is analysis.' },
          ...
          { type: 'mc', prompt: 'In an essay, the thesis plays the same role as a paragraph’s:', choices: ['simile', 'font', 'topic sentence', 'evidence'], answer: 2, hint: 'It states the big idea.', explain: 'The thesis is the essay-level topic sentence.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The position you ask a reader to accept is the:', choices: ['tone', 'simile', 'topic', 'claim'], answer: 3, hint: 'It must be arguable.', explain: 'That is the claim.' },
          ...
          { type: 'mc', prompt: 'The three classic appeals are logic, emotion, and:', choices: ['color', 'credibility', 'volume', 'length'], answer: 1, hint: 'Why should you be trusted?', explain: 'Credibility completes the three.' },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Government mainly exists to:', choices: ['make everyone rich', 'win every argument', 'entertain people', 'provide order and shared services'], answer: 3, hint: 'Think roads, safety, courts.', explain: 'Order and shared services are its core purpose.' },
          { type: 'mc', prompt: 'The rule of law means:', choices: ['even leaders must obey the law', 'there are no laws', 'only kings make laws', 'leaders can ignore laws'], answer: 0, hint: 'Who is above the law?', explain: 'No one is above the law — not even leaders.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which branch MAKES laws?', choices: ['judicial', 'military', 'legislative', 'executive'], answer: 2, hint: 'Congress lives here.', explain: 'The legislative branch (Congress) makes laws.' },
          { type: 'mc', prompt: 'Which branch CARRIES OUT (enforces) laws?', choices: ['judicial', 'local', 'legislative', 'executive'], answer: 3, hint: 'The President leads it.', explain: 'The executive branch enforces laws.' },
          { type: 'mc', prompt: 'Which branch decides what laws MEAN?', choices: ['judicial', 'all of them', 'legislative', 'executive'], answer: 0, hint: 'The Supreme Court is its top.', explain: 'The judicial branch interprets laws.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A President refusing to sign a bill is called a:', choices: ['election', 'law', 'veto', 'override'], answer: 2, hint: 'It blocks a bill from Congress.', explain: 'That refusal is a veto.' },
          { type: 'mc', prompt: 'Checks and balances exist to:', choices: ['give the President all power', 'end elections', 'speed things up', 'stop any branch from getting too powerful'], answer: 3, hint: 'It is about limiting power.', explain: 'They keep any one branch in check.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The Constitution is:', choices: ['a kind of election', 'the supreme law of the land', 'a type of tax', 'a branch of government'], answer: 1, hint: 'It outranks all other laws.', explain: 'It is the highest law in the country.' },
          ...
          { type: 'mc', prompt: 'Freedom of speech is protected by the:', choices: ['tax code', 'state flag', 'Bill of Rights', 'President alone'], answer: 2, hint: 'It is one of the first ten amendments.', explain: 'The Bill of Rights protects it.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'If the President vetoes a bill, Congress can:', choices: ['restart the country', 'override it with enough votes', 'do nothing ever', 'go to jail'], answer: 1, hint: 'A check meeting a counter-check.', explain: 'Congress can override the veto.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Sharing power between national and state governments is called:', choices: ['a monarchy', 'an amendment', 'federalism', 'a veto'], answer: 2, hint: 'Power split by level.', explain: 'That sharing is federalism.' },
          { type: 'mc', prompt: 'Local government usually handles:', choices: ['printing money', 'foreign treaties', 'national defense', 'trash and schools'], answer: 3, hint: 'Think of your neighborhood.', explain: 'Local governments run trash, schools, and similar services.' },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Scarcity means:', choices: ['no one wants anything', 'limited resources but unlimited wants', 'everything is free', 'too much of everything'], answer: 1, hint: 'It is a mismatch.', explain: 'Limited resources, unlimited wants.' },
          { type: 'mc', prompt: 'You pick a game over a book. The book is your:', choices: ['need', 'scarcity', 'opportunity cost', 'profit'], answer: 2, hint: 'What you gave up.', explain: 'The unchosen option is the opportunity cost.' },
          { type: 'mc', prompt: 'Which of these is a NEED?', choices: ['a new video game', 'designer shoes', 'a vacation', 'food and water'], answer: 3, hint: 'Required to live.', explain: 'Food and water are needs.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Too few goods for too many buyers is a:', choices: ['profit', 'tax', 'shortage', 'surplus'], answer: 2, hint: 'Demand outruns supply.', explain: 'That is a shortage.' },
          { type: 'mc', prompt: 'Lots of unsold leftover goods is a:', choices: ['shortage', 'need', 'bit', 'surplus'], answer: 3, hint: 'Supply outruns demand.', explain: 'That is a surplus.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'When revenue exactly equals cost, you are at:', choices: ['a surplus', 'break-even', 'huge profit', 'a shortage'], answer: 1, hint: 'Profit is zero.', explain: 'Revenue = cost is break-even.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A value proposition is:', choices: ['a kind of tax', 'a loop', 'the problem your business solves for customers', 'your total revenue'], answer: 2, hint: 'Why customers need you.', explain: 'It is the problem you solve.' },
          { type: 'mc', prompt: 'Your price should at least cover your:', choices: ['wishes', 'competitors’ dreams', 'homework', 'costs'], answer: 3, hint: 'Remember profit = revenue − cost.', explain: 'Price must cover costs.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Interest is usually:', choices: ['a kind of tax', 'a percent of the amount', 'always exactly $5', 'a random number'], answer: 1, hint: 'Tied to percents.', explain: 'It is a percent of the amount.' },
          { type: 'mc', prompt: 'Interest earned ON past interest is called:', choices: ['opportunity cost', 'a surplus', 'compound interest', 'simple interest'], answer: 2, hint: 'It snowballs.', explain: 'That is compound interest.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'A "limited edition" item can charge more due to:', choices: ['taxes', 'scarcity', 'higher costs only', 'lower demand'], answer: 1, hint: 'Fewer made, more wanted.', explain: 'Scarcity raises demand and price.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A market gap is:', choices: ['a store closing time', 'a tax', 'an unmet need no one serves well', 'a type of loan'], answer: 2, hint: 'It is an opening in the market.', explain: 'It is a need nobody is serving well yet.' },
          { type: 'mc', prompt: 'Business ideas most often start from:', choices: ['guessing randomly', 'copying homework', 'picking a logo', 'noticing a real problem'], answer: 3, hint: 'Think about annoyances.', explain: 'Real problems spark real businesses.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A target market is:', choices: ['a store shelf', 'the specific group you aim to serve', 'everyone alive', 'your total profit'], answer: 1, hint: 'Specific beats broad.', explain: 'It is your specific customer group.' },
          ...
          { type: 'mc', prompt: 'Market research means:', choices: ['raising prices', 'hiring friends', 'gathering real customer information', 'guessing what people want'], answer: 2, hint: 'Evidence, not assumption.', explain: 'It gathers real information.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A brand is mostly:', choices: ['only a logo', 'your bank balance', 'a kind of tax', 'the promise and reputation you keep'], answer: 3, hint: 'It lives in customers’ minds.', explain: 'It is the promise and reputation.' },
          ...
          { type: 'mc', prompt: 'A trusted brand can usually:', choices: ['avoid all competition', 'charge more and win customers faster', 'ignore its customers', 'skip making profit'], answer: 1, hint: 'Trust reduces buyer risk.', explain: 'Trust lets a brand charge more.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Pricing far below competitors can make customers think:', choices: ['it must be luxury', 'it is illegal', 'it is heavy', 'something is wrong with it'], answer: 3, hint: 'Very cheap can signal low quality.', explain: 'Suspiciously low prices raise doubts.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The best marketing channel is usually:', choices: ['always television', 'wherever your target market already is', 'the most expensive one', 'the loudest one'], answer: 1, hint: 'Go where they already spend time.', explain: 'Meet customers where they already are.' },
          ...
          { type: 'mc', prompt: 'Smart marketers decide where to spend by:', choices: ['spending equally everywhere', 'never advertising', 'measuring which channel brings customers', 'flipping a coin'], answer: 2, hint: 'Track the results.', explain: 'Measure, then invest where it works.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'An elevator pitch is:', choices: ['a long report', 'a type of loan', 'a price tag', 'a short clear explanation of your business'], answer: 3, hint: 'It fits in an elevator ride.', explain: 'It is a fast, clear explanation.' },
          ...
          { type: 'mc', prompt: 'A business plan is mostly built from:', choices: ['song lyrics', 'things you already studied: market, pricing, profit', 'secret codes', 'random guesses'], answer: 1, hint: 'It is your whole lane, written down.', explain: 'It assembles what you already learned.' },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A fossil is:', choices: ['a living animal', 'a modern bone', 'preserved evidence of ancient life', 'any old rock'], answer: 2, hint: 'It is a message from the past.', explain: 'Preserved evidence of ancient life.' },
          { type: 'mc', prompt: 'A dinosaur footprint is a:', choices: ['body fossil', 'mineral', 'mixture', 'trace fossil'], answer: 3, hint: 'Evidence of activity, not a body part.', explain: 'A footprint is a trace fossil.' },
          { type: 'mc', prompt: 'A preserved bone is a:', choices: ['body fossil', 'footprint', 'burrow', 'trace fossil'], answer: 0, hint: 'It is a part of the organism.', explain: 'A bone is a body fossil.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The first key step in fossilizing is usually:', choices: ['melting', 'rapid burial in sediment', 'being eaten', 'floating in the ocean forever'], answer: 1, hint: 'Protect the remains fast.', explain: 'Quick burial protects the remains.' },
          { type: 'mc', prompt: 'Which parts fossilize most easily?', choices: ['blood', 'fur only', 'bones and shells', 'skin and muscle'], answer: 2, hint: 'The hard parts last.', explain: 'Hard parts survive; soft parts decay.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Layers of rock are called:', choices: ['bytes', 'strata', 'fossils', 'minerals'], answer: 1, hint: 'One layer is a stratum.', explain: 'Rock layers are strata.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'A half-life is the time for ____ of a material to decay:', choices: ['a quarter', 'half', 'all', 'none'], answer: 1, hint: 'It is in the name.', explain: 'Half decays in one half-life.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The age of the dinosaurs was the:', choices: ['Cenozoic era', 'Paleozoic era', 'Modern era', 'Mesozoic era'], answer: 3, hint: 'The "middle life" era.', explain: 'Dinosaurs ruled the Mesozoic.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Non-bird dinosaurs died out about:', choices: ['6,000 years ago', 'yesterday', '66 million years ago', 'last century'], answer: 2, hint: 'Tens of millions of years.', explain: 'About 66 million years ago.' },
          { type: 'mc', prompt: 'Many scientists link that extinction to a(n):', choices: ['sudden snowball', 'lack of food only', 'human hunters', 'asteroid impact'], answer: 3, hint: 'A crater and rare metal are clues.', explain: 'Evidence points to an asteroid impact.' },
