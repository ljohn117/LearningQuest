    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Keeping stable internal conditions is called:', choices: ['photosynthesis', 'reproduction', 'homeostasis', 'erosion'], answer: 2, hint: 'Think of body temperature.', explain: 'That is homeostasis.' },
          { type: 'mc', prompt: 'All living things are made of:', choices: ['plastic', 'sand', 'metal', 'cells'], answer: 3, hint: 'The basic unit of life.', explain: 'Cells are the building block of life.' },
          ...
          { type: 'mc', prompt: 'Which is NOT on the list of traits of living things?', choices: ['using energy', 'being made of metal', 'reproducing', 'responding to surroundings'], answer: 1, hint: 'Three of these are real traits.', explain: 'Being metal is not a trait of life.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which part is the cell’s control center?', choices: ['cell wall', 'membrane', 'nucleus', 'mitochondria'], answer: 2, hint: 'It holds the DNA.', explain: 'The nucleus controls the cell.' },
          { type: 'mc', prompt: 'Which part releases usable energy from food?', choices: ['chloroplast', 'nucleus', 'cell wall', 'mitochondria'], answer: 3, hint: 'Known as the powerhouse.', explain: 'Mitochondria release energy.' },
          { type: 'mc', prompt: 'Which is found in plant cells but NOT animal cells?', choices: ['cell wall', 'membrane', 'mitochondria', 'nucleus'], answer: 0, hint: 'It gives plants stiffness.', explain: 'Plant cells have one and animal cells do not. Bacteria and fungi have walls too — animals are the odd ones out here.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Photosynthesis releases:', choices: ['helium', 'nitrogen', 'carbon dioxide', 'oxygen'], answer: 3, hint: 'The gas you breathe in.', explain: 'It releases oxygen.' },
          ...
          { type: 'mc', prompt: 'Photosynthesis and cellular respiration are related how?', choices: ['they are the same process running in different cells', 'one stores energy in sugar, the other releases it', 'both release the energy already stored in sugar', 'both occur only in plants, never in animals'], answer: 1, hint: 'Compare what goes in with what comes out.', explain: 'One takes carbon dioxide, water and light and makes sugar and oxygen. The other runs that backwards to get the energy out.' },
          { type: 'mc', prompt: 'The original source of nearly all energy for life is:', choices: ['the Moon', 'soil', 'the Sun', 'wind'], answer: 2, hint: 'Photosynthesis starts with it.', explain: 'Energy traces back to the Sun.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A section of DNA coding for a trait is a:', choices: ['fossil', 'nucleus', 'cell wall', 'gene'], answer: 3, hint: 'It carries one instruction.', explain: 'That is a gene.' },
          { type: 'mc', prompt: 'A recessive trait appears only when:', choices: ['both copies are recessive', 'there is no DNA', 'one copy is recessive', 'it is dominant'], answer: 0, hint: 'Dominant wins whenever present.', explain: 'Both copies must be recessive.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The science of naming and grouping organisms is:', choices: ['geology', 'economics', 'taxonomy', 'astronomy'], answer: 2, hint: 'It creates the classification system.', explain: 'That is taxonomy.' },
          { type: 'mc', prompt: 'Which is the MOST specific level?', choices: ['phylum', 'class', 'kingdom', 'species'], answer: 3, hint: 'Run down the taxonomy order — kingdom, phylum, class, order, family, genus, species. The narrowest is at the end.', explain: 'Species is the most specific level.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Plants that make their own food are called:', choices: ['predators', 'consumers', 'producers', 'decomposers'], answer: 2, hint: 'They produce food from sunlight.', explain: 'Plants are producers.' },
          { type: 'mc', prompt: 'Organisms that break down dead material are:', choices: ['consumers', 'fossils', 'producers', 'decomposers'], answer: 3, hint: 'They recycle nutrients.', explain: 'Those are decomposers.' },
          ...
          { type: 'mc', prompt: 'In an ecosystem:', choices: ['energy flows one way, matter is recycled', 'both energy and matter are recycled', 'matter flows one way, energy is recycled', 'neither is recycled'], answer: 0, hint: 'What do decomposers actually return to the soil?', explain: 'Energy arrives as sunlight and leaves as heat — one way. Matter gets returned and used again and again.' },
          { type: 'mc', prompt: 'Food chains are usually short because:', choices: ['large predators cannot find enough territory', 'most of the energy is lost as heat at each level', 'most animals prefer to eat plants directly', 'longer chains need more species than exist'], answer: 1, hint: 'Only 10% passes up.', explain: 'Energy loss limits chain length.' },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The part of a sentence telling what the subject does is the:', choices: ['title', 'subject', 'predicate', 'adjective'], answer: 2, hint: 'It carries the action.', explain: 'That is the predicate.' },
          { type: 'mc', prompt: 'Which can stand alone as a sentence?', choices: ['a phrase', 'a dependent clause', 'a fragment', 'an independent clause'], answer: 3, hint: 'The name is a hint.', explain: 'Independent clauses stand alone.' },
          { type: 'mc', prompt: '"Because the rain stopped" is a:', choices: ['dependent clause', 'paragraph', 'complete sentence', 'independent clause'], answer: 0, hint: 'Does it feel finished?', explain: 'It cannot stand alone — dependent.' },
          { type: 'mc', prompt: 'A complete sentence needs:', choices: ['a subject only', 'a subject and a predicate', 'a verb only', 'at least eight words'], answer: 1, hint: 'Who or what, and what they do.', explain: 'Both halves. “The dog” is not a sentence; “The dog barked” is.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The main idea is:', choices: ['the subject the text is about', 'the opening sentence of the passage', 'the point the text makes about its subject', 'a summary of every paragraph in order'], answer: 2, hint: 'It is a claim, not just a subject.', explain: 'It is the central point.' },
          { type: 'mc', prompt: 'Facts and examples that back up the main idea are:', choices: ['a predicate', 'the topic', 'a fragment', 'supporting evidence'], answer: 3, hint: 'They make it believable.', explain: 'That is supporting evidence.' },
          { type: 'mc', prompt: '"Sharks" is a topic. Which is a main idea?', choices: ['Sharks are misunderstood and vital to oceans', 'Sharks live in every ocean on Earth', 'Sharks and other large ocean predators', 'There are over 500 species of shark'], answer: 0, hint: 'A main idea makes a claim.', explain: 'It states a point, not just a subject.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: '"Quiet as a held breath" is a:', choices: ['fact', 'metaphor', 'simile', 'personification'], answer: 2, hint: 'Look for like or as.', explain: 'It uses "as" — a simile.' },
          { type: 'mc', prompt: '"Her voice was gravel" is a:', choices: ['clause', 'simile', 'summary', 'metaphor'], answer: 3, hint: 'It says one thing IS another.', explain: 'That is a metaphor.' },
          { type: 'mc', prompt: '"The wind argued with the door" is:', choices: ['personification', 'imagery only', 'a fragment', 'a simile'], answer: 0, hint: 'Wind cannot argue.', explain: 'Human traits given to wind — personification.' },
          { type: 'mc', prompt: 'Language that appeals to the senses is:', choices: ['a thesis', 'imagery', 'taxonomy', 'a predicate'], answer: 1, hint: 'It creates pictures and sounds.', explain: 'That is imagery.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The three common author’s purposes are inform, entertain, and:', choices: ['ignore', 'confuse', 'persuade', 'repeat'], answer: 2, hint: 'Ads do this one.', explain: 'To persuade.' },
          { type: 'mc', prompt: 'An author’s attitude toward the subject is the:', choices: ['genre', 'clause', 'topic', 'tone'], answer: 3, hint: 'Word choice reveals it.', explain: 'That is tone.' },
          { type: 'mc', prompt: 'A story using "I" is written in:', choices: ['first person', 'second person only', 'no point of view', 'third person'], answer: 0, hint: 'The narrator is in the story.', explain: 'Using I is first person.' },
          { type: 'mc', prompt: '"The mob swarmed" instead of "the crowd gathered" changes the:', choices: ['font', 'tone', 'length only', 'page number'], answer: 1, hint: 'It changes how you feel.', explain: 'Word choice shifts tone.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Explaining WHY your evidence supports your point is:', choices: ['imagery', 'evidence', 'tone', 'analysis'], answer: 3, hint: 'The step most writers skip.', explain: 'That is analysis.' },
          ...
          { type: 'mc', prompt: 'In an essay, the thesis plays the same role as a paragraph’s:', choices: ['evidence', 'topic sentence', 'font', 'simile'], answer: 1, hint: 'It states the big idea.', explain: 'The thesis is the essay-level topic sentence.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The position you ask a reader to accept is the:', choices: ['topic', 'tone', 'claim', 'simile'], answer: 2, hint: 'It must be arguable.', explain: 'That is the claim.' },
          ...
          { type: 'mc', prompt: 'Answering the strongest objection to your own claim:', choices: ['strengthens it', 'weakens your argument', 'makes no difference', 'is only worth doing in long essays'], answer: 0, hint: 'What does doing it show the reader?', explain: 'It shows you considered the objection and the claim survived. Ignoring it just leaves the objection standing unanswered.' },
          { type: 'mc', prompt: 'The three classic appeals are logic, emotion, and:', choices: ['volume', 'credibility', 'length', 'color'], answer: 1, hint: 'Why should you be trusted?', explain: 'Credibility completes the three.' },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Government mainly exists to:', choices: ['make sure everyone earns the same', 'settle arguments between families', 'decide what people should believe', 'provide order and shared services'], answer: 3, hint: 'Think roads, safety, courts.', explain: 'Order and shared services are its core purpose.' },
          { type: 'mc', prompt: 'The rule of law means:', choices: ['even leaders must obey the law', 'only kings make laws', 'leaders can ignore laws', 'there are no laws'], answer: 0, hint: 'Who is above the law?', explain: 'No one is above the law — not even leaders.' },
          { type: 'mc', prompt: 'The social contract idea says people:', choices: ['give up every freedom they have to the state', 'give up some freedom in return for protection', 'gain more freedom without giving anything up', 'sign an actual written contract as citizens'], answer: 1, hint: 'Think about why you stop at a red light.', explain: 'You give up the freedom to drive straight through, and get roads where everyone else stops too.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which branch MAKES laws?', choices: ['military', 'judicial', 'executive', 'legislative'], answer: 3, hint: 'Congress lives here.', explain: 'The legislative branch (Congress) makes laws.' },
          ...
          { type: 'mc', prompt: 'Which branch decides what laws MEAN?', choices: ['all of them', 'judicial', 'executive', 'legislative'], answer: 1, hint: 'The Supreme Court is its top.', explain: 'The judicial branch interprets laws.' },
          ...
          { type: 'mc', prompt: 'Power is split between three branches mainly in order to:', choices: ['make government act more quickly', 'give every state its own branch', 'reduce the cost of running the country', 'stop any one part controlling everything'], answer: 3, hint: 'What would the alternative make possible?', explain: 'It is deliberately slower. Slow is the price; no single point of control is what that price buys.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A President refusing to sign a bill is called a:', choices: ['veto', 'law', 'override', 'election'], answer: 0, hint: 'It blocks a bill from Congress.', explain: 'That refusal is a veto.' },
          { type: 'mc', prompt: 'Checks and balances exist to:', choices: ['make decisions happen more quickly', 'stop any branch from getting too powerful', 'give the President the final say', 'reduce the number of elections held'], answer: 1, hint: 'It is about limiting power.', explain: 'They keep any one branch in check.' },
          { type: 'mc', prompt: 'A presidential veto can be overturned by:', choices: ['nobody — a veto is the final word', 'the Supreme Court acting on its own', 'a two-thirds vote in both chambers', 'a national referendum of the voters'], answer: 2, hint: 'A check can meet a counter-check.', explain: 'Congress can override with two-thirds in both chambers — checks and balances running in both directions.' },
          { type: 'mc', prompt: 'The courts can declare a law:', choices: ['free', 'permanent forever', 'secret', 'unconstitutional'], answer: 3, hint: 'They check it against the Constitution.', explain: 'Courts can strike laws down as unconstitutional.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The Constitution is:', choices: ['the supreme law of the land', 'a kind of election', 'a branch of government', 'a type of tax'], answer: 0, hint: 'It outranks all other laws.', explain: 'It is the highest law in the country.' },
          ...
          { type: 'mc', prompt: 'The Constitution is changed by:', choices: ['a Supreme Court ruling', 'presidential order', 'amendment', 'a simple majority in the House'], answer: 2, hint: 'There have been 27 of them in total.', explain: 'Amendments — and deliberately hard ones to pass, which is why there are only 27 in over two centuries.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Before a bill can become law it must pass:', choices: ['both the House and the Senate', 'the House of Representatives only', 'the Senate and the Supreme Court', 'the Senate only, then the President'], answer: 0, hint: 'Congress has two chambers.', explain: 'Both chambers, and then the President signs — or Congress overrides a veto.' },
          { type: 'mc', prompt: 'After Congress passes a bill, it goes to the:', choices: ['voters directly', 'President', 'state governor', 'Supreme Court'], answer: 1, hint: 'The executive branch signs laws.', explain: 'The President signs or vetoes it.' },
          { type: 'mc', prompt: 'If the President vetoes a bill, Congress can:', choices: ['do nothing further about it', 'send it to the Supreme Court', 'override it with a two-thirds vote', 'call a national referendum'], answer: 2, hint: 'A check meeting a counter-check.', explain: 'Congress can override the veto.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Sharing power between national and state governments is called:', choices: ['an amendment', 'a monarchy', 'a veto', 'federalism'], answer: 3, hint: 'Power split by level.', explain: 'That sharing is federalism.' },
          ...
          { type: 'mc', prompt: 'The most direct way a citizen decides who holds power is:', choices: ['paying taxes', 'voting', 'jury service', 'writing to a newspaper'], answer: 1, hint: 'Your most direct civic power.', explain: 'Voting. The others matter, but only one of them actually chooses who takes the office.' },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Scarcity means:', choices: ['there is not enough money to buy things', 'some goods have run out completely', 'prices rise faster than most incomes do', 'resources are limited while wants are not'], answer: 3, hint: 'It is a mismatch.', explain: 'Limited resources, unlimited wants.' },
          ...
          { type: 'mc', prompt: 'Because resources are scarce, every choice you make:', choices: ['makes the resource less scarce for others', 'can be avoided by saving more money', 'costs you the next best thing you gave up', 'only matters for expensive purchases'], answer: 2, hint: 'If you spend the money here, what did you not spend it on?', explain: 'Every choice has an opportunity cost — the best thing you did not pick. That is what makes scarcity bite even when you can afford something.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The price where supply meets demand is the:', choices: ['equilibrium price', 'surplus', 'opportunity cost', 'profit'], answer: 0, hint: 'The balance point.', explain: 'That is the equilibrium price.' },
          ...
          { type: 'mc', prompt: 'Too few goods for too many buyers is a:', choices: ['profit', 'surplus', 'shortage', 'tax'], answer: 2, hint: 'Demand outruns supply.', explain: 'That is a shortage.' },
          { type: 'mc', prompt: 'Lots of unsold leftover goods is a:', choices: ['need', 'bit', 'shortage', 'surplus'], answer: 3, hint: 'Supply outruns demand.', explain: 'That is a surplus.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Profit equals revenue minus:', choices: ['cost', 'supply', 'taxes only', 'demand'], answer: 0, hint: 'Money out.', explain: 'Profit = revenue − cost.' },
          ...
          { type: 'mc', prompt: 'When revenue exactly equals cost, you are at:', choices: ['huge profit', 'break-even', 'a surplus', 'a shortage'], answer: 1, hint: 'Profit is zero.', explain: 'Revenue = cost is break-even.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A value proposition is:', choices: ['the total revenue a business expects', 'the price you decide to charge', 'the problem your business solves for customers', 'the group of people you plan to sell to'], answer: 2, hint: 'Why customers need you.', explain: 'It is the problem you solve.' },
          { type: 'mc', prompt: 'Your price should at least cover your:', choices: ['homework', 'wishes', 'competitors’ dreams', 'costs'], answer: 3, hint: 'Remember profit = revenue − cost.', explain: 'Price must cover costs.' },
          { type: 'mc', prompt: 'Naming one specific customer helps mainly because:', choices: ['you can make and say something that fits them', 'it makes your potential market much bigger', 'it reduces the cost of making the product', 'investors will not fund you without one'], answer: 0, hint: 'Imagine writing one advert that must work on everyone alive.', explain: 'A specific person lets you make specific choices. “Everyone” gives you nothing at all to aim at.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Interest earned ON past interest is called:', choices: ['a surplus', 'simple interest', 'opportunity cost', 'compound interest'], answer: 3, hint: 'It snowballs.', explain: 'That is compound interest.' },
          { type: 'mc', prompt: 'Over many years, compound interest compared with simple interest:', choices: ['grows faster', 'grows at the same rate', 'grows more slowly', 'only differs for very large amounts'], answer: 0, hint: 'Interest earning interest snowballs.', explain: 'Compound pays interest on the interest already earned, so the gap between them widens every single year.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Marketing is mainly about:', choices: ['persuading people to buy what they do not need', 'communicating what your product is worth', 'lowering your price below competitors', 'making your product look better than it is'], answer: 1, hint: 'Make people aware and interested.', explain: 'It communicates value.' },
          ...
          { type: 'mc', prompt: 'Competition tends to push businesses to:', choices: ['merge immediately', 'raise prices freely', 'stop innovating', 'improve, or lose customers'], answer: 3, hint: 'What happens if a rival is both better and cheaper?', explain: 'If someone else is better, customers move. That pressure is what drives the improving.' },
          { type: 'mc', prompt: 'A "limited edition" item can charge more due to:', choices: ['scarcity', 'lower demand', 'taxes', 'higher costs only'], answer: 0, hint: 'Fewer made, more wanted.', explain: 'Scarcity raises demand and price.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A market gap is:', choices: ['a period when a business makes no sales', 'a need that nobody currently serves well', 'the difference between cost and price', 'a shop that has closed down for good'], answer: 1, hint: 'It is an opening in the market.', explain: 'It is a need nobody is serving well yet.' },
          { type: 'mc', prompt: 'Business ideas most often start from:', choices: ['copying homework', 'guessing randomly', 'noticing a real problem', 'picking a logo'], answer: 2, hint: 'Think about annoyances.', explain: 'Real problems spark real businesses.' },
          { type: 'mc', prompt: 'Which question separates a business from a hobby?', choices: ['Is this something I enjoy doing?', 'Can I fit it around everything else?', 'Is anyone else already doing it?', 'Would someone pay me to solve this?'], answer: 3, hint: 'Money must actually change hands.', explain: 'Willingness to pay makes it a business.' },
          { type: 'mc', prompt: 'Testing a small version of an idea first mainly saves you:', choices: ['the cost of building the wrong thing', 'nothing — it just delays the launch', 'the need to find customers', 'the need for any plan'], answer: 0, hint: 'Cheaper to learn early.', explain: 'Finding out it is wrong after a week costs a week. Finding out after a year costs a year.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A target market is:', choices: ['the total profit you expect to make', 'the specific group you aim to serve', 'everyone who could possibly buy it', 'the shelf space your product takes'], answer: 1, hint: 'Specific beats broad.', explain: 'It is your specific customer group.' },
          ...
          { type: 'mc', prompt: 'Market research means:', choices: ['guessing what you think people want', 'asking friends whether they like it', 'finding out what customers actually do', 'setting a price below competitors'], answer: 2, hint: 'Evidence, not assumption.', explain: 'It gathers real information.' },
          { type: 'mc', prompt: 'Aiming a product at “everyone” usually:', choices: ['reaches more buyers than targeting does', 'guarantees you a much bigger market', 'reduces what you spend on advertising', 'makes it hard to say anything specific'], answer: 3, hint: 'Everyone is not a customer.', explain: 'You end up describing it so vaguely that no particular person feels it was made for them.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A brand is mostly:', choices: ['the promise people learn to rely on', 'the logo and colours you choose', 'the amount you spend advertising', 'the name printed on the package'], answer: 0, hint: 'It lives in customers’ minds.', explain: 'It is the promise and reputation.' },
          { type: 'mc', prompt: 'Positioning answers:', choices: ['how much cash we have', 'why pick us instead of them', 'who our landlord is', 'what day it is'], answer: 1, hint: 'It is differentiation in words.', explain: 'It states who you serve and why you are different.' },
          { type: 'mc', prompt: 'A brand is built mainly by:', choices: ['a good logo', 'how much is spent on advertising', 'keeping the same promise every time', 'a clever name'], answer: 2, hint: 'Trust comes from repetition.', explain: 'A brand is a promise people have learned they can rely on. The logo is only how they recognise it.' },
          { type: 'mc', prompt: 'A trusted brand can usually:', choices: ['stop competing with other businesses', 'stop paying attention to its customers', 'make a profit without selling anything', 'charge more and win customers faster'], answer: 3, hint: 'Trust reduces buyer risk.', explain: 'Trust lets a brand charge more.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Charging based on what the solution is worth to the buyer is:', choices: ['value-based pricing', 'a surplus', 'break-even', 'cost-plus pricing'], answer: 0, hint: 'It looks at the customer, not the cost.', explain: 'That is value-based pricing.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The marketing funnel describes:', choices: ['how customers are grouped by age', 'the formula for working out profit', 'the stages from awareness to purchase', 'the order in which products are made'], answer: 2, hint: 'Wide at the top, narrow at the bottom.', explain: 'It maps awareness through to buying.' },
          { type: 'mc', prompt: 'The best marketing channel is usually:', choices: ['the one that reaches the most people', 'the cheapest one available to you', 'the one your competitors are not using', 'wherever your target market already is'], answer: 3, hint: 'Go where they already spend time.', explain: 'Meet customers where they already are.' },
          { type: 'mc', prompt: 'Word of mouth works mainly because:', choices: ['people trust a friend more than an advert', 'it reaches far more people than adverts', 'it costs a business nothing at all', 'it spreads faster than paid advertising'], answer: 0, hint: 'Trust is the reason, not the price.', explain: 'A friend has nothing to sell you. That is exactly what makes their recommendation worth more than an advert.' },
          { type: 'mc', prompt: 'Smart marketers decide where to spend by:', choices: ['spreading the budget evenly everywhere', 'measuring which channel brings customers', 'copying what the biggest rival does', 'choosing the cheapest option each time'], answer: 1, hint: 'Track the results.', explain: 'Measure, then invest where it works.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'An elevator pitch is:', choices: ['a written report for investors to read', 'the price you plan to charge customers', 'a short clear explanation of your business', 'a summary of your costs and profits'], answer: 2, hint: 'It fits in an elevator ride.', explain: 'It is a fast, clear explanation.' },
          { type: 'mc', prompt: 'Which belongs in a business plan?', choices: ['the history of your whole industry', 'the exact date you will be rich', 'a list of everyone you admire most', 'costs, pricing, and expected profit'], answer: 3, hint: 'It covers how money works.', explain: 'Costs, pricing, and profit are core sections.' },
          ...
          { type: 'mc', prompt: 'A pitch is stronger when it:', choices: ['uses specific numbers you can back up', 'avoids numbers so it sounds bigger', 'uses mostly adjectives', 'runs as long as possible'], answer: 0, hint: 'Evidence beats hope.', explain: 'Specific, checkable numbers are what separate a plan from a wish.' },
          { type: 'mc', prompt: 'A business plan is mostly built from:', choices: ['guesses about what might happen', 'market, pricing and profit worked out', 'whatever investors want to hear', 'the plans of similar businesses'], answer: 1, hint: 'It is your whole lane, written down.', explain: 'It assembles what you already learned.' },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A fossil is:', choices: ['any rock that looks unusually old', 'the bone of a recently dead animal', 'preserved evidence of ancient life', 'a living animal of an old species'], answer: 2, hint: 'It is a message from the past.', explain: 'Preserved evidence of ancient life.' },
          { type: 'mc', prompt: 'A dinosaur footprint is a:', choices: ['mixture', 'body fossil', 'mineral', 'trace fossil'], answer: 3, hint: 'Evidence of activity, not a body part.', explain: 'A footprint is a trace fossil.' },
          { type: 'mc', prompt: 'A preserved bone is a:', choices: ['body fossil', 'trace fossil', 'burrow', 'footprint'], answer: 0, hint: 'It is a part of the organism.', explain: 'A bone is a body fossil.' },
          { type: 'mc', prompt: 'Of all the living things that have ever existed, the proportion that fossilised is:', choices: ['most of them', 'a tiny fraction', 'about half', 'all the ones with bones'], answer: 1, hint: 'Fossilising needs rare conditions.', explain: 'It needs rapid burial and usually hard parts. Almost everything decays instead — which is why the record has the gaps it does.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The first key step in fossilizing is usually:', choices: ['floating in the ocean forever', 'being eaten', 'rapid burial in sediment', 'melting'], answer: 2, hint: 'Protect the remains fast.', explain: 'Quick burial protects the remains.' },
          { type: 'mc', prompt: 'Which parts fossilize most easily?', choices: ['fur only', 'blood', 'skin and muscle', 'bones and shells'], answer: 3, hint: 'The hard parts last.', explain: 'Hard parts survive; soft parts decay.' },
          { type: 'mc', prompt: 'Minerals replacing bone to make stone is called:', choices: ['permineralization', 'evaporation', 'erosion', 'melting'], answer: 0, hint: 'Mineral-rich water seeps in.', explain: 'That process is permineralization.' },
          { type: 'mc', prompt: 'Fossil formation usually takes:', choices: ['a few years at most, given heat', 'thousands to millions of years', 'a few months in wet conditions', 'a single season of hard frost'], answer: 1, hint: 'Think in geological time.', explain: 'Thousands to millions of years, as minerals gradually replace the original material.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'In undisturbed rock, the OLDEST layer is:', choices: ['impossible to tell', 'at the top', 'at the bottom', 'in the middle'], answer: 2, hint: 'Which was laid down first?', explain: 'The bottom layer formed first, so it is oldest.' },
          { type: 'mc', prompt: 'Layers of rock are called:', choices: ['bytes', 'fossils', 'minerals', 'strata'], answer: 3, hint: 'One layer is a stratum.', explain: 'Rock layers are strata.' },
          { type: 'mc', prompt: 'A fossil found in a deeper rock layer is generally:', choices: ['older than one above it', 'exactly the same age', 'younger than one above it', 'impossible to date'], answer: 0, hint: 'Which layer had to be laid down first?', explain: 'Deeper means laid down earlier, so older. That is the law of superposition.' },
          { type: 'mc', prompt: '"Deeper means older" is the law of:', choices: ['supply and demand', 'superposition', 'motion', 'gravity'], answer: 1, hint: 'About stacked layers.', explain: 'That is the law of superposition.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Ordering fossils by rock layer (no exact age) is:', choices: ['absolute dating', 'guessing', 'relative dating', 'permineralization'], answer: 2, hint: 'Just the sequence.', explain: 'That is relative dating.' },
          { type: 'mc', prompt: 'Getting an actual age in years uses:', choices: ['fossil size', 'rock color', 'pure guessing', 'radioactive decay'], answer: 3, hint: 'A steady atomic clock.', explain: 'Radioactive decay enables absolute dating.' },
          { type: 'mc', prompt: 'A half-life is the time for ____ of a material to decay:', choices: ['half', 'none', 'a quarter', 'all'], answer: 0, hint: 'It is in the name.', explain: 'Half decays in one half-life.' },
          ...
          { type: 'mc', prompt: 'Radioactive decay works as a clock because:', choices: ['it speeds up when the rock is heated', 'it decays at a steady, known rate', 'it stops after a million years', 'it happens only inside fossils'], answer: 1, hint: 'What makes any clock useful at all?', explain: 'A steady rate that ordinary conditions do not change. That is what makes counting what is left meaningful.' },
        ],
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The age of the dinosaurs was the:', choices: ['Modern era', 'Cenozoic era', 'Paleozoic era', 'Mesozoic era'], answer: 3, hint: 'The "middle life" era.', explain: 'Dinosaurs ruled the Mesozoic.' },
          { type: 'mc', prompt: 'If Earth’s whole history were squeezed into one 24-hour day, humans would appear:', choices: ['in the last minute or so', 'around midday', 'at breakfast', 'right at the start'], answer: 0, hint: '4.6 billion years against a couple of hundred thousand.', explain: 'In the last fraction of a minute. Nearly all of Earth’s history happened with nobody there to see it.' },
          { type: 'mc', prompt: 'The huge spans of Earth’s past are called:', choices: ['last week', 'deep time', 'recess', 'a half-life'], answer: 1, hint: 'Millions to billions of years.', explain: 'That is deep time.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A mass extinction is when:', choices: ['one animal moves to a new region', 'a single volcano becomes dormant', 'many species die out in a short time', 'a particularly good fossil forms'], answer: 2, hint: 'Large-scale loss of life.', explain: 'Many species die out quickly.' },
          ...
          { type: 'mc', prompt: 'Many scientists link that extinction to a(n):', choices: ['asteroid impact', 'human hunters', 'lack of food only', 'sudden snowball'], answer: 0, hint: 'A crater and rare metal are clues.', explain: 'Evidence points to an asteroid impact.' },
          ...
          { type: 'mc', prompt: 'The big lesson fossils teach is that life on Earth:', choices: ['is only 100 years old', 'never changes', 'changes over time', 'has no history'], answer: 2, hint: 'From the whole fossil story.', explain: 'Life is always changing.' },
        ],
      },
    ],
  },
