  ...
  physics: [
    {
      ...
      quiz: [
        ...
        { type: 'mc', prompt: 'The single idea holding all six days together is best stated as:', choices: ['matter is particles, change costs energy, and the total is conserved', 'energy is heat', 'forces cause motion', 'everything is made of atoms'], answer: 0, hint: 'Which one covers all six days rather than one?', explain: 'The other options are each true but only cover part of it.' },
      ],
    },
  ],
  ...
  logic: [
    {
      ...
      quiz: [
        { type: 'mc', prompt: '"This is outrageous" cannot be evaluated logically because it:', choices: ['is unpopular', 'has no evidence', 'is too short', 'carries no truth value'], answer: 3, hint: 'Could it be true or false?', explain: 'It is not a statement, so logic has nothing to work with.' },
        ...
        { type: 'mc', prompt: 'Ice cream sales and drownings both rise in summer. Concluding one causes the other is:', choices: ['mistaking correlation for cause', 'a counterexample', 'circular reasoning', 'valid'], answer: 0, hint: 'What third thing explains both?', explain: 'Hot weather drives both.' },
        ...
        { type: 'mc', prompt: 'An argument that is valid AND has true premises is called:', choices: ['formal', 'sound', 'certain', 'strong'], answer: 1, hint: 'One word covers both.', explain: 'Sound. Valid plus true premises.' },
      ],
    },
  ],
  ...
  earth: [
    {
      ...
      quiz: [
        ...
        { type: 'mc', prompt: 'What do Earth’s interior, the deep past and a text’s meaning have in common?', choices: ['they can all be observed directly', 'they are all reconstructed from evidence left behind', 'they are all unknowable', 'they all require a microscope'], answer: 1, hint: 'Which one can you actually watch happen?', explain: 'None can be watched. All are read from traces.' },
      ],
    },
  ],
};
