  ...
  chem: [
    {
      ...
      quiz: [
        ...
        { type: 'tf', prompt: 'The electrons in an atom’s outer layer decide how it will react.', answer: true, hint: 'Which part of an atom meets another atom first?', explain: 'Valence electrons do the bonding. It is why the periodic table works at all.' },
        ...
        { type: 'tf', prompt: 'A catalyst is consumed by the reaction it speeds up.', answer: false, hint: 'What happens to an enzyme after it works?', explain: 'It emerges unchanged and starts again — which is the only reason your body can rely on them.' },
      ],
    },
  ],
};
