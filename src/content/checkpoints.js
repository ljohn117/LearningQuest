  ...
  physics: [
    {
      ...
      quiz: [
        { type: 'mc', prompt: 'Temperature is best understood as:', choices: ['total energy in an object', 'how fast the particles are moving on average', 'how much matter is present', 'how much heat has been added'], answer: 1, hint: 'It is an average about motion.', explain: 'Average kinetic energy of the particles.' },
  ...
  logic: [
    {
      ...
      quiz: [
        ...
        { type: 'mc', prompt: 'Ice cream sales and drownings both rise in summer. Concluding one causes the other is:', choices: ['a counterexample', 'circular reasoning', 'valid', 'mistaking correlation for cause'], answer: 3, hint: 'What third thing explains both?', explain: 'Hot weather drives both.' },
        ...
        { type: 'mc', prompt: '"If it rains the game is cancelled. The game was cancelled, so it rained." This is:', choices: ['valid', 'confusing a conditional with its converse', 'proof by cases', 'a false dilemma'], answer: 1, hint: 'Could the game be cancelled for another reason?', explain: 'The converse is a different claim.' },
        ...
        { type: 'mc', prompt: 'The reasoning holds, but one premise turns out to be false. The argument is:', choices: ['valid but not sound', 'invalid', 'circular', 'sound'], answer: 0, hint: 'Soundness needs both halves — good reasoning AND true premises.', explain: 'Valid reasoning with a false premise. Valid, but not sound.' },
      ],
    },
  ],
  ...
  earth: [
    {
      ...
      quiz: [
        ...
        { type: 'mc', prompt: 'How do we know what Earth’s interior is made of?', choices: ['earthquake wave speeds', 'volcano samples only', 'deep drilling', 'satellite images'], answer: 0, hint: 'No drill has reached the mantle.', explain: 'Seismic waves change speed in different materials.' },
        { type: 'mc', prompt: 'Earth’s seasons are caused by:', choices: ['the moon', 'ocean currents', 'distance from the sun', 'the tilt of the axis'], answer: 3, hint: 'Earth is closest to the sun in January.', explain: 'Axial tilt changes how directly sunlight lands.' },
        ...
        { type: 'mc', prompt: 'What do Earth’s interior, the deep past and a text’s meaning have in common?', choices: ['they all require a microscope', 'they can all be observed directly', 'they are all reconstructed from evidence left behind', 'they are all unknowable'], answer: 2, hint: 'Which one can you actually watch happen?', explain: 'None can be watched. All are read from traces.' },
      ],
    },
  ],
};
