    ...
    days: [
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'To solve 5x + 2 = 17, the correct FIRST step is:', choices: ['Multiply by 5', 'Divide by 5', 'Subtract 2 from both sides', 'Add 2 to both sides'], answer: 2, hint: 'Peel from the outside: handle the + 2 first.', explain: 'Remove +2 first, then divide by 5.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'What is 5⁰?', choices: ['5', 'undefined', '0', '1'], answer: 3, hint: 'Follow the dividing pattern down from 5¹.', explain: 'Any nonzero number to the 0 power is 1.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Review — x³ · x⁴ equals:', choices: ['x¹', 'x⁷', 'x¹²', 'x'], answer: 1, hint: 'Add the exponents when the base matches.', explain: '3 + 4 = 7, so x⁷.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: '3 × 10⁸ is the same as:', choices: ['30,000,000', '3,000,000', '38', '300,000,000'], answer: 3, hint: '10⁸ has eight zeros.', explain: '3 followed by 8 zeros.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The solution to a system of two lines is:', choices: ['always (0,0)', 'the longer line', 'the steeper line', 'the point where they cross'], answer: 3, hint: 'One point satisfies BOTH equations.', explain: 'It is the crossing point.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'The graph of y = x² is a:', choices: ['circle', 'single point', 'straight line', 'parabola (U-shape)'], answer: 3, hint: 'Squaring bends the graph.', explain: 'It is a U-shaped parabola.' },
    ...
    days: [
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'The four basic computer jobs are input, process, output, and:', choices: ['sleeping', 'storage', 'magic', 'guessing'], answer: 1, hint: 'Where does data get saved?', explain: 'Storage is the fourth job.' },
          { type: 'mc', prompt: 'Typing on a keyboard is an example of:', choices: ['storage', 'process', 'input', 'output'], answer: 2, hint: 'Information coming IN.', explain: 'Keyboard typing is input.' },
          { type: 'mc', prompt: 'A screen showing your results is:', choices: ['storage', 'a bug', 'input', 'output'], answer: 3, hint: 'Information going OUT.', explain: 'The display is output.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Pseudocode is:', choices: ['a programming language', 'a kind of bug', 'a password', 'plain-language steps before real code'], answer: 3, hint: 'A planning tool.', explain: 'It plans the algorithm in plain words.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A loop is used to:', choices: ['turn off the computer', 'repeat steps', 'make a single decision', 'store one value'], answer: 1, hint: 'It handles repetition.', explain: 'Loops repeat steps.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Text data like "hello" is called a:', choices: ['loop', 'string', 'integer', 'boolean'], answer: 1, hint: 'A string of characters.', explain: 'Text is a string.' },
          { type: 'mc', prompt: 'A true/false value is a:', choices: ['number', 'pixel', 'boolean', 'string'], answer: 2, hint: 'Only two possible values.', explain: 'True/false is a boolean.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A "bug" in code is:', choices: ['a feature', 'a loop', 'a fast computer', 'an error'], answer: 3, hint: 'Something gone wrong.', explain: 'A bug is an error.' },
          ...
          { type: 'mc', prompt: 'Debugging is most like:', choices: ['taking a nap', 'detective work and elimination', 'guessing randomly', 'giving up'], answer: 1, hint: 'Rule out the impossible.', explain: 'It is detective-style elimination.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'A programming language is:', choices: ['a type of mouse', 'a spreadsheet', 'precise words a computer understands', 'a kind of hardware'], answer: 2, hint: 'It is how you give instructions.', explain: 'It lets you give exact instructions.' },
          { type: 'mc', prompt: 'Syntax means:', choices: ['a bug', 'a fast computer', 'a variable', 'the exact grammar rules of the language'], answer: 3, hint: 'Spelling and punctuation rules.', explain: 'Syntax is the language’s grammar.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which command prints something out in JavaScript?', choices: ['show.text', 'console.log', 'print.now', 'say.it'], answer: 1, hint: 'It logs to the console.', explain: 'console.log prints output.' },
          { type: 'mc', prompt: 'Text wrapped in quotation marks is called a:', choices: ['loop', 'bug', 'string', 'number'], answer: 2, hint: 'A string of characters.', explain: 'Quoted text is a string.' },
          { type: 'mc', prompt: 'What does console.log(5 + 3) print?', choices: ['5 + 3', '53', 'nothing', '8'], answer: 3, hint: 'No quotes means it does the math.', explain: 'It calculates and prints 8.' },
      ...
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'Which line correctly creates a variable?', choices: ['make score', 'let score = 0;', 'variable score 0', 'score := 0'], answer: 1, hint: 'Start with the word let.', explain: 'let score = 0; is the JavaScript way.' },
          { type: 'mc', prompt: 'In code, the = sign means:', choices: ['add', 'compare', 'store this value in the box', 'is exactly equal to'], answer: 2, hint: 'It assigns rather than compares.', explain: 'It stores a value.' },
      ...
      },
      {
        ...
        quiz: [
          ...
          { type: 'mc', prompt: 'Code that runs when the if condition is false goes in:', choices: ['again', 'end', 'stop', 'else'], answer: 3, hint: 'The backup path.', explain: 'else handles the false case.' },
          ...
          { type: 'mc', prompt: 'A comparison like score > 90 produces a:', choices: ['variable name', 'boolean (true or false)', 'string', 'loop'], answer: 1, hint: 'Only two possible results.', explain: 'It gives true or false.' },
        ],
      },
      {
        ...
        quiz: [
          { type: 'mc', prompt: 'What does i++ do?', choices: ['deletes i', 'prints i', 'adds 1 to i', 'doubles i'], answer: 2, hint: 'It is the step part of the loop.', explain: 'It increases i by 1.' },
          ...
          { type: 'mc', prompt: 'To print 2, 4, 6, 8, 10 from i = 1 to 5, you log:', choices: ['i * 3', 'i + 5', 'i', 'i * 2'], answer: 3, hint: 'What turns 1 into 2 and 5 into 10?', explain: 'Multiplying by 2 gives the even numbers.' },
